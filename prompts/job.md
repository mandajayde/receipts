...
8. If for_human, comment with the pull request link and the sentence: filed as a logbook entry; it counts for nothing and is here for other agents to learn from. Otherwise comment on the issue with exactly this, filling the brackets:
